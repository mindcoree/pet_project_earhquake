...
Примеры аналитических SQL-запросов для проверки качества данных и исследования землетрясений.

- `01_data_quality_checks.sql` - контрольные проверки ODS/DM и целостности факта.
